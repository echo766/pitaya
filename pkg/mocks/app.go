...
// Source: github.com/echo766/pitaya (interfaces: Pitaya)
...
import (
	...
	cluster "github.com/echo766/pitaya/pkg/cluster"
	component "github.com/echo766/pitaya/pkg/component"
	config "github.com/echo766/pitaya/pkg/config"
	interfaces "github.com/echo766/pitaya/pkg/interfaces"
	metrics "github.com/echo766/pitaya/pkg/metrics"
	"github.com/echo766/pitaya/pkg/route"
	router "github.com/echo766/pitaya/pkg/router"
	session "github.com/echo766/pitaya/pkg/session"
	worker "github.com/echo766/pitaya/pkg/worker"
...
func (m *MockPitaya) GetZoneID() string {
	m.ctrl.T.Helper()
...
func (mr *MockPitayaMockRecorder) GetZoneID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetZoneID", reflect.TypeOf((*MockPitaya)(nil).GetZoneID))
}
...
// GetSessionFromCtx mocks base method
func (m *MockPitaya) GetRouteFromCtx(arg0 context.Context) *route.Route {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRouteFromCtx", arg0)
	ret0, _ := ret[0].(*route.Route)
	return ret0
}

// GetRouteFromCtx retrieves a session from a given context
func (mr *MockPitayaMockRecorder) GetRouteFromCtx(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRouteFromCtx", reflect.TypeOf((*MockPitaya)(nil).GetRouteFromCtx), arg0)
}
